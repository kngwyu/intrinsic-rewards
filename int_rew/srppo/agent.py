...
from .config import SrPpoConfig
from ..rollout import IntValueRolloutStorage


class SrPpoAgent(PpoAgent):
    """PPO version of https://arxiv.org/abs/1807.11622
    """
    def __init__(self, config: SrPpoConfig) -> None:
        ...
        if not self.config.normalize_int_reward:
            ...
            self.irew_gen.normalize_reward = False
